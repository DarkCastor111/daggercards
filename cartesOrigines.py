...
if titre_carte == "origine":
    styles.add(ParagraphStyle(name="CardType", fontSize=11, leading=18, alignment=0, textColor=colors.darkslategray, backColor=colors.darkturquoise, fontName="Helvetica-Bold", spaceAfter=4))
else:
    styles.add(ParagraphStyle(name="CardType", fontSize=11, leading=18, alignment=0, textColor=colors.maroon, backColor=colors.orange, fontName="Helvetica-Bold", spaceAfter=4))
...
styles.add(ParagraphStyle(name="CardSub", fontSize=8, leading=8, alignment=2, textColor=colors.black, fontName="Helvetica-Bold", spaceAfter=4))
styles.add(ParagraphStyle(name="CardText", fontSize=8, leading=9, alignment=4, fontName="Helvetica", spaceAfter=2))
