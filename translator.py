...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    ...
    "origine": {"en": "COMMUNITY", "fr": "COMMUNAUTÉ", "es": "todo"},
    "ascendance": {"en": "ANCESTRY", "fr": "ASCENDANCE", "es": "todo"},
    "rappel": {"en": "Recall", "fr": "Rappel ", "es": "todo"},
    "foundations": {"en": "Foundation", "fr": "Base", "es": "todo"},
    "specializations": {"en": "Specialization", "fr": "Spécialisation", "es": "todo"},
    "masteries": {"en": "Mastery", "fr": "Maîtrise", "es": "todo"},
    ...
    "classe wizard": {"en": "Wizard", "fr": "Mage", "es": "todo"},
    ...
    "ppage sstitre rang": {"en": "Tier:", "fr": "Palier :", "es": "todo"},
    ...
    "ppage pack wizard": {"en": "Wizard", "fr": "Mage (Wizard)", "es": "todo"},
    ...
    "classe espoir": {"en": "Hope Feature", "fr": "Aptitude d'Espoir", "es": "todo"},
    "classe capacites": {"en": "Class Features", "fr": "Aptitudes de Classe", "es": "todo"},
    ...
    "ppage copyright bbe": {"en": "All Rights Reserved.", 
                  "fr": "All Rights Reserved. Sous licence Black Book Editions, tous droits réservés.", 
